...
const Support = () => {
    ...
    const fetchResponseContent = async (responseName) => {
        setIsLoading(true);
        const response = await axios.get(`http://localhost:5000/responses/${responseName}`);
    ...
    const handleResponseClick = (responseName) => {
        setSelectedResponse(responseName);
        fetchResponseContent(responseName);
    };

    const handleSupportRequest = async () => {
        setIsLoading(true);
        await axios.post('http://localhost:5000/support', { query, email: userEmail });
        fetchResponses();
    };
    ...
    return (
        <Container ref={ref}>
            ...
            <ResponsesContainer>
                <ResponsesList>
                    <h2 style={{color:"white"}}>Responses</h2>
